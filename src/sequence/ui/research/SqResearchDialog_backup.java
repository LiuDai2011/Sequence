//package Sequence.ui;
//
//import Sequence.world.research.ResearchNode;
//import Sequence.world.research.ResearchTree;
//import arc.Core;
//import arc.Events;
...
//
//public class SqResearchDialog_backup extends BaseDialog {
//    public final float nodeSize = Scl.scl(60f);
//    public ObjectSet<ResearchTreeNode> nodes = new ObjectSet<>();
//    public ResearchTreeNode root = new ResearchTreeNode(ResearchTree.roots.first(), null);
//    public ResearchNode lastNode = root.node;
...
//
//    public SqResearchDialog_backup() {
//        super("");
//
//        titleTable.remove();
//        titleTable.clear();
...
//
//            Planet currPlanet = Planets.serpulo;
//
...
//    }
//
//    public void switchTree(ResearchNode node) {
//        if (lastNode == node || node == null) return;
//        nodes.clear();
//        root = new ResearchTreeNode(node, null);
//        lastNode = node;
//        view.rebuildAll();
//
//        rebuildItems();
//    }
//
//    public void rebuildTree(ResearchNode node) {
//        switchTree(node);
//        view.panX = 0f;
//        view.panY = -200f;
//        view.setScale(1f);
...
//        for (ResearchTreeNode l : node.children) {
...
//                    button.getStyle().up = !locked(node.node) ? buttonOver : !selectable(node.node) || !canSpend(node.node) ? Tex.buttonRed : Tex.button;
//
...
//            node.content.unlock();
//
//            ResearchNode parent = node.parent;
//            while (parent != null) {
